...
lambda_content=1.0
lambda_rec=10.0
model_path=lr_${lr}_bs_${batch_size}_style_${lambda_style}_content_${lambda_content}_rec_${lambda_rec}
...
python train.py --lr ${lr} --batch_size ${batch_size} --lambda_style ${lambda_style} \
 ...
 --start_idx ${start_idx} --epochs ${epochs} --lambda_rec ${lambda_rec}
