...
config.base_dir = '/home/likewise-open/SENSETIME/xuyongzhe/Code/contextualLoss/'
config.single_image_B_file_name = 'images/trump_cartoon.jpg'
config.vgg_model_path = config.base_dir + 'imagenet-vgg-verydeep-19.mat'
#---------------------------------------------
...
config.TRAIN.A_data_dir = 'dataset/train'
...
config.VAL = edict()
config.VAL.A_data_dir = 'dataset/test'
...
config.expirament_postfix = 'single_im_D32_42_1.0_DC42_1.0'
